...
When plugged to PC host, the STM32G474E must be properly enumerated as an USB Serial device and an STlink Com port.
...
Those descriptors are used by host driver to identify the device capabilities. Once STM32G474 USB device successfully completed the enumeration phase,
...
RTOS, ThreadX, USBX, USB_Device, Full Speed, CDC, VCP, USART, DMA.
