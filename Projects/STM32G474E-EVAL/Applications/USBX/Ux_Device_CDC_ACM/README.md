...
This application provides an example of Azure RTOS USBX stack usage on STM32G474E-EVAL board, it shows how to develop USB Device communication Class "CDC_ACM" based application.
...
When plugged to PC host, the STM32G474E-EVAL must be properly enumerated as an USB Serial device and an STlink Com port.
...
### <b>Hardware and Software environment</b>
  ...
  - Connect the STM32G474E-EVAL board CN22 "TYPE-C" to the PC through
