...
This application provides an example of Azure RTOS USBX stack usage on STM32G474E-EVAL board, it shows how to develop a composite USB Device communication
...
When plugged to PC host, the STM32G474E-EVAL must be properly enumerated a composite device as an HID ,USB Serial device and an STlink Com port.
...
Those descriptors are used by host driver to identify the device capabilities. Once STM32G474E-EVAL USB device successfully completed the enumeration phase.
...
RTOS, ThreadX, USBX, USBXDevice, USB, High Speed, CDC, HID, VCP, USART, DMA, Mouse.
...
### <b>Hardware and Software environment</b>
  ...
  - Connect the STM32G474E-EVAL board CN22 to the PC through "TYPE-C" to "Standard A" cable.
