...
####  <b>Expected success behavior</b>
  ...
  - GREEN_LED is Off when system is in LowPower mode.
  - GREEN_LED toggles every 500ms for 5 seconds each time user press the user button.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics STM32G474RE-NUCLEO board MB1367 Revision C-04
